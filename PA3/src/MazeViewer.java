...
public class MazeViewer {
   ...
   */
   private static MazeFrame readMazeFile(String fileName) throws IOException {
        ...
        MazeCoord entryLoc = new MazeCoord(input.nextInt(), input.nextInt());
        MazeCoord exitLoc = new MazeCoord(input.nextInt(), input.nextInt());

        frame = new MazeFrame(mazeData,entryLoc,exitLoc);
